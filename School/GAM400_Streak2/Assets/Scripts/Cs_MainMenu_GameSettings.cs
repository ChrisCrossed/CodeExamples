...
public struct GameSettings
{
    ...
    public GameSettings(bool b_2w_2h_, bool b_2w_3h_, bool b_3w_2h_, bool b_3w_3h_, bool b_ThreeBlocks_, int i_BoardWidth_, int i_BoardHeight_, int _i_DropTimer) : this()
    {
        ...
        this._i_DropTimer = _i_DropTimer;
    }
...
public class Cs_MainMenu_GameSettings : MonoBehaviour
{
    ...
    public void Set_GameSettings(bool b_2w_2h_, bool b_2w_3h_, bool b_3w_2h_, bool b_3w_3h_, bool b_ThreeBlocks_, int i_BoardWidth_, int i_BoardHeight_, int i_DropTimer_)
    {
